  ...
  popupDialog = $(
    [
      ...
      '<div class="api-popup-content">',
        '<p><strong>' + appName + '</strong> offers the following Oauth scopes. Select which ones you want to grant before performing operations on your data. After selecting, you will need to login to an account to access its data.</p>',
